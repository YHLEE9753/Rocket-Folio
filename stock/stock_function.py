...
# KOSPI KOSDAQ 크롤링함수
def kospi_kosdaq_function() -> list:
    ...
    result.append(kospi_value)
    result.append(kosdaq_value)
...
def fusion_donut(stock_data, sum_data):
    ...
    chartConfig["captionFontSize"] = "24"
...
def fusion_line(month, result_price):
    ...
    # Create an object for the column 2D chart using the FusionCharts class constructor
    # The chart data is passed to the `dataSource` parameter.
    Line2D = FusionCharts("line", "ex1" , "1460", "900", "chart-1", "json", dataSource)
